...
Client slug: `emorrison_consulting`

Agency slug: `arc`

Website: https://www.emorrisonconsulting.com/
...
- `build/{date}_account_rebuild/emorrison_consulting_google_ads_editor_staging_{YYYYMMDD_HHMMSS}.csv`
